...
set_property -dict {LOC K7  IOSTANDARD LVDS } [get_ports {sfp_mgt_refclk_p}] ;# MGTREFCLK0P_227 from Y1
set_property -dict {LOC K6  IOSTANDARD LVDS } [get_ports {sfp_mgt_refclk_n}] ;# MGTREFCLK0N_227 from Y1
